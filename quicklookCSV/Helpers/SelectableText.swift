...
import Foundation
import SwiftUI
//https://stackoverflow.com/questions/58005434/how-do-i-allow-text-selection-on-a-text-label-in-swiftui
...
struct SelectableText: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> CustomUITextField {
        let textField = CustomUITextField(frame: .infinite)
        textField.delegate = textField
        textField.text = self.text
        textField.backgroundColor = UIColor(ciColor: .gray)
